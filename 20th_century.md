...
## Data:
A publicly available dataset scraped from the [20th century](https://en.wikipedia.org/wiki/20th_century) Wikipedia page, containing unstructured historical records of global political events, milestones, and international relations used for text mining and network mapping. 
